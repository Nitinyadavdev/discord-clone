  ...
  return (
    <>
      <footer className="bg-black text-white py-20">
        <div className="container flex flex-col lg:flex-row  items-start   justify-between gap-20 lg:gap-32">
          {/* Left Side */}
          <div>
            <h4 className="text-primary text-4xl font-blackhans ">
              Imagine A <br /> Place
            </h4>
            {/* Social Icons */}
        ...
        <div className="container  ">
          <div className="  pt-10 flex items-center justify-between  border-t border-primary mt-10">
            <svg
              width="124"
              height="34"
              viewBox="0 0 124 34"
            ...
            <button className="btn bg-primary text-white rounded-full hover:shadow-lg shadow-primary">
              Sign Up
            </button>
          </div>
        </div>
